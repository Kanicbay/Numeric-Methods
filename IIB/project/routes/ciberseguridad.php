        ...
        <div class="row">
            <div class="col-md-12 h-100" id="colPD">
                ...
                <p class="lead">El siguiente estudio toma en cuenta un ambiente con cierta cantidad de depredadores y 
                    ...
                    diferenciales ordinarias y otros parametros.
                </p>
                <image src="https://t2.ea.ltmcdn.com/es/posts/1/2/0/animales_depredadores_significado_tipos_y_ejemplos_24021_600.jpg">
                <br/> <br/>
                <p class="lead">El modelo en particular se considera como un modelo depredador-presa y caos. 
